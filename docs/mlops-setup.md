...
git add README.md docs .gitignore titanic_june_2024/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-7674599708099350.10.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-7674599708099350.10.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[titanic_june_2024/databricks.yml](../titanic_june_2024/databricks.yml) file.
...
Follow the instructions in [titanic_june_2024/resources/README.md](../titanic_june_2024/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../titanic_june_2024/resources/README.md)  to propose, test, and deploy
